...
The `src/cli/` directory provides the command-line interface for installing and configuring **oh-my-opencode-lite**, an OpenCode plugin. It handles:
...
```
User runs: bunx oh-my-opencode-lite install [--no-tui] [--tmux=yes|no] [--skills=yes|no] [--dry-run] [--reset]
          │
          ▼
┌─────────────────────────────────────────┐
│ index.ts: parseArgs()                   │
...
└─────────────────┬───────────────────────┘
                  ...
                  ▼
┌─────────────────────────────────────────┐
│ Parse oh-my-opencode-lite.json/jsonc   │
│ - Extract preset name                   │
...
| `oh-my-opencode-lite.json` | `~/.config/opencode/` | Plugin-specific lite config |
...
1. **End Users**: Via `bunx oh-my-opencode-lite install`
...
InstallConfig (preferences)
         ...
         │    - Plugin registration ('oh-my-opencode-lite')
