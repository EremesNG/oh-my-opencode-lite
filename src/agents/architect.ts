...
2. Determine the right subagent:
   ...
   - ANY UI/UX/frontend task → @designer (owns frontend decisions, implementation, AND visual verification. Describe the GOAL, not the solution — @designer decides the approach, implements, and verifies via browser)
