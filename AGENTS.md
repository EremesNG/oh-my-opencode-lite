...
**oh-my-opencode-lite** - A lightweight agent orchestration plugin for OpenCode, a lite fork of oh-my-opencode. Built with TypeScript, Bun, and Biome.
...
# "plugin": ["file:///path/to/oh-my-opencode-lite"]
