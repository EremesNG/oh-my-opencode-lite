...
const outputPath = join(rootDir, 'oh-my-opencode-lite.schema.json');
...
const jsonSchema = {
  ...
  title: 'oh-my-opencode-lite',
  description:
    'Configuration schema for oh-my-opencode-lite plugin for OpenCode',
};
