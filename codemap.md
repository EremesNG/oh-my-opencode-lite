...
**oh-my-opencode-lite** is a lightweight agent orchestration plugin for OpenCode - a lite fork of oh-my-opencode. It provides a multi-agent system that enables specialized AI agents to work together under an orchestrator to optimize coding tasks for quality, speed, cost, and reliability.
...
|------|---------|-------------|
| `package.json` | Project manifest, dependencies, and build scripts | `oh-my-opencode-lite` CLI, `dist/index.js` main entry |
