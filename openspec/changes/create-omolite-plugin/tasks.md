...
- [ ] 0.1 Update `src/config/schema.ts`
...
- [ ] 0.2 Update `src/config/constants.ts`
...
- [ ] 0.3 Update `src/config/agent-mcps.ts`
...
- [ ] 0.4 Update `src/config/loader.ts`
...
- [ ] 0.5 Update `src/config/index.ts`
...
- [ ] 1.1 Create `src/delegation/types.ts`
...
- [ ] 1.2 Create `src/delegation/paths.ts`
...
- [ ] 1.3 Create `src/delegation/project-id.ts`
...
- [ ] 1.4 Create `src/delegation/delegation-manager.ts`
...
- [ ] 1.5 Create `src/delegation/index.ts`
...
- [ ] 2.3 Create `src/thoth/client.ts`
...
- [ ] 2.5 Create `src/hooks/thoth-mem/protocol.ts`
...
- [ ] 2.6 Create `src/hooks/thoth-mem/index.ts`
...
- [ ] 3.1 Create `src/agents/prompt-utils.ts`
...
- [ ] 3.2 Rewrite `src/agents/orchestrator.ts`
...
- [ ] 3.3 Rewrite `src/agents/explorer.ts`
...
- [ ] 3.4 Rewrite `src/agents/librarian.ts`
...
- [ ] 3.5 Rewrite `src/agents/oracle.ts`
...
- [ ] 3.6 Rewrite `src/agents/designer.ts`
...
- [ ] 3.7 Create `src/agents/quick.ts`
...
- [ ] 3.9 Update `src/agents/index.ts`
...
- [ ] 3.10 Delete `src/agents/fixer.ts`
...
- [ ] 4.1 Update `src/background/background-manager.ts`
...
- [ ] 4.2 Update `src/background/background-manager.ts`
  **Files:** Modify: `src/background/background-manager.ts`
...
- [ ] 4.3 Update `src/background/index.ts`
...
- [ ] 4.4 Update `src/tools/background.ts`
...
- [ ] 5.1 Create `src/skills/_shared/openspec-convention.md`
...
- [ ] 5.2 Create `src/skills/_shared/persistence-contract.md`
...
- [ ] 5.3 Create `src/skills/_shared/thoth-mem-convention.md`
...
- [ ] 5.4 Create `src/skills/sdd-propose/SKILL.md`
...
- [ ] 5.5 Create `src/skills/sdd-spec/SKILL.md`
...
- [ ] 5.6 Create `src/skills/sdd-design/SKILL.md`
...
- [ ] 5.7 Create `src/skills/sdd-tasks/SKILL.md`
...
- [ ] 5.8 Create `src/skills/sdd-apply/SKILL.md`
...
- [ ] 5.9 Create `src/skills/sdd-verify/SKILL.md`
...
- [ ] 5.10 Create `src/skills/sdd-archive/SKILL.md`
...
- [ ] 5.11 Update `src/cli/custom-skills.ts`
...
- [ ] 7.1 Update `src/cli/providers.ts`
...
- [ ] 7.7 Regenerate `oh-my-opencode-lite.schema.json`
...
- [ ] 8.1 Update `src/config/loader.test.ts`
...
- [ ] 8.2 Update `src/mcp/index.test.ts`
...
- [ ] 8.3 Update `src/agents/index.test.ts`
...
- [ ] 8.4 Create `src/delegation/delegation-manager.test.ts`
...
- [ ] 8.5 Create `src/thoth/client.test.ts`
...
- [ ] 8.6 Create `src/hooks/thoth-mem/index.test.ts`
...
- [ ] 8.7 Update `src/background/background-manager.test.ts`
...
- [ ] 8.8 Create `src/tools/background.test.ts`
...
- [ ] 8.9 Update `src/hooks/delegate-task-retry/index.test.ts`
...
- [ ] 8.10 Update `src/cli/providers.test.ts` and `src/cli/skills.test.ts`
